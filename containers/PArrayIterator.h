#ifndef UTIL_P_ARRAY_ITERATOR_H
#define UTIL_P_ARRAY_ITERATOR_H
...
namespace Util
{
   ...
   *
   * An PArrayIterator is an abstraction of a pointer, similar to an STL
   ...
   */
   ...
   public:
      ...
      *
      * \return this PArrayIterator, after modification.
      */
